...
- Branch naming: `feat/QBT-xxx` for features, `fix/QBT-xxx` for bugs, `chore/` for housekeeping
- Commit messages: use conventional commits — `feat:`, `fix:`, `chore:`, `refactor:`, `test:`
- Never commit directly to `main` — always use a branch + pull request
- Do not add "Generated by Claude", "Co-authored-by: Claude", or any AI tool attribution to commits
